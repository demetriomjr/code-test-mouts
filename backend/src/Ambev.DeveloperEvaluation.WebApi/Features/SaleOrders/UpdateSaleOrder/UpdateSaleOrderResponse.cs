...
/// <summary>
/// API response model for UpdateSaleOrder operation.
/// </summary>
public class UpdateSaleOrderResponse
{
    /// <summary>
    /// The unique identifier of the updated sale order.
    /// </summary>
    ...
    /// </summary>
    public IEnumerable<UpdateSaleOrderItemResponse> Products { get; set; } = [];
...
/// <summary>
/// Represents a product item within a sale order update response.
/// </summary>
public class UpdateSaleOrderItemResponse
{
    /// <summary>
